...
class DBStore(Store):
    ...
    def __contains__(self, key):
        ...
        return bool(data.list())  #bool(list(data))  #20140408 dongyg: list() occur a error on sqlserver, .list() does not
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            if self.db.dbtype=='oracle':
                return self.decode(str(s.data))
            else:
