...
_fileobject_uses_str_type = isinstance(socket._fileobject(fakeNone)._rbuf, basestring)
...
class ThreadPool(object):
    ...
    def put(self, obj):
        #20161103 dongyg: keep idle threads on 10-20
        if self._get_idle()>=20:
            self.shrink(5)
        elif self._get_idle()<=10:
            self.grow(5)
        self._queue.put(obj)
